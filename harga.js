...
for (let jasa of CONFIG.jasa){
    let itemHeader = `<div class="flex flex-col p-6 text-lg bg-white border border-gray-200 shadow-lg md:p-8 rounded-xl">
    ...
    <div class="flex flex-col gap-4">
        <a href="gallery.html"
            class="flex flex-row items-center justify-center gap-4 px-4 py-3 text-base font-semibold text-white transition duration-200 bg-blue-500 rounded-lg hover:bg-blue-600">
            Lihat Hasil Foto Kami
        </a>
        <a href="${whatsapp.link}" target="_blank"
            class="flex flex-row items-center justify-center gap-4 px-4 py-3 text-base font-semibold text-white transition duration-200 bg-green-500 rounded-lg hover:bg-green-600 ">
